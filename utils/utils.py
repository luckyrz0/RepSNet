...
# def viz_valid_step_pretrained(out, feed_dict):
#     img = feed_dict["img"].data.numpy()
#     boundary_distance_pred = out["boundary_distance_map"].to("cpu").data.numpy()
#     boundary_distance_true = feed_dict["boundary_distance_map"].data.numpy()
...
#     ture_viz_list = [img]
#     ture_viz_list.append(colorize(boundary_distance_true[...,0], 0, 7).reshape(-1,256,256,3))
#     ture_viz_list.append(colorize(boundary_distance_true[...,1], 0, 7).reshape(-1,256,256,3))
#     ture_viz_list.append(colorize(boundary_distance_true[...,2], 0, 7).reshape(-1,256,256,3))
#     ture_viz_list.append(colorize(boundary_distance_true[...,3], 0, 7).reshape(-1,256,256,3))

#     pred_viz_list = [instance_img_true]
#     pred_viz_list.append(colorize(boundary_distance_pred[:,0], 0, 7).reshape(-1,256,256,3))
#     pred_viz_list.append(colorize(boundary_distance_pred[:,1], 0, 7).reshape(-1,256,256,3))
#     pred_viz_list.append(colorize(boundary_distance_pred[:,2], 0, 7).reshape(-1,256,256,3))
#     pred_viz_list.append(colorize(boundary_distance_pred[:,3], 0, 7).reshape(-1,256,256,3))

#     output_img = np.concatenate([np.concatenate(ture_viz_list, axis=1), np.concatenate(pred_viz_list, axis=1)], axis=2)
#     return output_img

# def viz_valid_step(out, feed_dict):
#     num_types = out["type_map"].shape[1]
...
#     ture_viz_list = [instance_img_true]
#     ture_viz_list.append(colorize(nucleus_true, 0, 1).reshape(-1,256,256,3))
#     ture_viz_list.append(colorize(type_true, 0, num_types).reshape(-1,256,256,3))
#     ture_viz_list.append(colorize(boundary_true==1, 0, 1).reshape(-1,256,256,3))
#     for i in range(boundary_distance_true.shape[-1]):
#         ture_viz_list.append(colorize(boundary_distance_true[...,i], 0, 7).reshape(-1,256,256,3))

#     pred_viz_list = [instance_img_pred]
#     pred_viz_list.append(colorize(nucleus_pred, 0, 1).reshape(-1,256,256,3))
#     pred_viz_list.append(colorize(type_pred, 0, num_types).reshape(-1,256,256,3))
#     pred_viz_list.append(colorize(boundary_pred>0, 0, 1).reshape(-1,256,256,3))
#     for i in range(boundary_distance_pred.shape[1]):
#         pred_viz_list.append(colorize(boundary_distance_pred[:,i], 0, 7).reshape(-1,256,256,3))
